...
$consulta_insertar_usuario = "INSERT INTO Usuarios (nombre_usuario, password_usuario, correo_usuario, tipo_usuario) VALUES ('$usuario', '$contrasena', '$email', '$tipo_usuario')";
